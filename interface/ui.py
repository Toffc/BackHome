...
class Ui():
    def __init__(self, ai_settings, stats):
        ...
        self.button_setting = Button('material/image/setting.png', 'material/image/setting_down.png', ai_settings.screen, (200,380))
        self.button_about = Button('material/image/about.png', 'material/image/about_down.png', ai_settings.screen, (200,420))
